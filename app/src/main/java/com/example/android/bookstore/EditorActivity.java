...
public class EditorActivity extends AppCompatActivity implements
    ...
    /** TextView field to display the product's current quantity*/
    ...
    private EditText mPhoneEditText;
     ...
     /** Boolean flag that keeps track of whether the product has been edited (true) or not (false_ */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuantityTextView = (TextView) findViewById(R.id.button_decrement);
        mQuantityTextView = (TextView) findViewById(R.id.button_increment);
         ...
         */
        int currentQuantity = Integer.parseInt(findViewById(R.id.textview_quantity).toString());

        // This method is called when the plus button is clicked.
        public void increment(View view) {
           if (currentQuantity == 1000) {
                // Show an error message as a toast
                Toast.makeText(this, getString(R.string.max_product_toast), Toast.LENGTH_SHORT).show();
                return;
            }
       ...
       /**
        ...
        public void decrement(View view) {
            if (currentQuantity== 0) {
                // Show an error message as a toast
                Toast.makeText(this, getString(R.string.min_product_toast), Toast.LENGTH_SHORT).show();
                return;
            }
            currentQuantity = currentQuantity - 1;
            displayQuantity(currentQuantity);
        ...
        public void displayQuantity(int quantity) {
            TextView quantityTextView = findViewById(R.id.textview_quantity);
    ...
    private void saveProduct() {
        ...
        values.put(ProductEntry.COLUMN_SUPPLIER_PHONE, phoneString);
        ...
        if (mCurrentProductUri == null) {
            ...
            if (TextUtils.isEmpty(nameString) ||
                    ...
                    TextUtils.isEmpty(supplierString) ||
                    TextUtils.isEmpty(phoneString)) {
                Toast.makeText(this, getString(R.string.toast_pls_complete),
    ...
    public void dialPhoneToOrder(String phone) {

        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:" + phone)); // only phone apps should handle this
